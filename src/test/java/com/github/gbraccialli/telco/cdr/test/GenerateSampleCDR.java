...
public class GenerateSampleCDR {
	...
	final static String[] dropReasons = new String[]{ 
		...
		"Bad SIM Card Error",
		"Improper enabling/disabling of 3G",
		"Incorrect 4G signal settings",
		"Geolocation specific week signal",
		"High Altitude causing service failures",
		"Improper transition between Wi-Fi calling and the service provider network",
		"No 4G LTE service",
		"Invalid downgrade from 4G service  to 2G"
	};
